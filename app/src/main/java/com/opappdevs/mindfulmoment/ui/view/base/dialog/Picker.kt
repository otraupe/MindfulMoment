...
fun Picker(
    ...
    //TODO: does not respond as quickly
//    LaunchedEffect(listState.isScrollInProgress) {
//        if (!listState.isScrollInProgress) {
//            state.selectedItem = getItem(listState.firstVisibleItemIndex + visibleItemsMiddle)
//            Timber.d("Scroll not in progress, selected item: ${state.selectedItem}")
//        }
//    }
    ...
    Box(modifier = modifier) {
        ...
        HorizontalDivider(
            ...
            thickness = dimensionResource(R.dimen.mindful_base_divider_thickness),
            color = dividerColor
        )
        HorizontalDivider(
